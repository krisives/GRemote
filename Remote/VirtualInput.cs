...
namespace GRemote
{
    class VirtualInput
    {
        ...
        {
            /*
           // PostMessage(targetWindowPtr, WM_KEYDOWN, 0x44, 0);
          //  SendKeys.Send("d");
           ...
           // keybd_event(0x44, (byte)ScanCodeShort.KEY_D, 0, UIntPtr.Zero);
          //  keybd_event(0x44, (byte)ScanCodeShort.KEY_D, (uint)KEYEVENTF.KEYUP, UIntPtr.Zero);
        }
